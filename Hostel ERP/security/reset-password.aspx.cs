    ...
    public partial class WebForm2 : System.Web.UI.Page
    {
        ...
        private void fetchPassword()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("select password from [security_profile] where registration_no='" + Session["security_registration"].ToString() + "'", con);
        ...
        private void updatePassword()
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("update [security_profile] set password=@password where registration_no='" + Session["security_registration"].ToString() + "'", con);
